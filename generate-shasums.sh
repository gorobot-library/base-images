...
node_shasums() {
  ...
  for node_ver in "${node_versions[@]}"; do
    ...
    echo "$(cat ${tmp}/SHASUMS256.txt)" >> ${node_shasum_file}
...
python_shasums() {
  ...
  python_versions=(
    "3.6.1" "3.4.6" "3.5.3" "3.6.0" "2.7.13" "3.4.5" "3.5.2" "2.7.12" "3.4.4"
    "3.5.1" "2.7.11" "3.5.0" "2.7.10" "3.4.3" "2.7.9" "3.4.2" "3.3.6" "3.2.6"
    "2.7.8" "2.7.7" "3.4.1" "3.4.0" "3.3.5" "3.3.4" "3.3.3" "2.7.6" "2.6.9"
    "3.2.5" "3.3.2" "2.7.5" "3.2.4" "3.3.1" "2.7.4" "3.3.0" "3.2.3" "2.6.8"
    "2.7.3" "3.1.5" "3.2.2" "3.2.1" "2.7.2" "3.1.4" "2.6.7" "2.5.6" "3.2.0"
    "2.7.1" "3.1.3" "2.6.6" "2.7.0" "3.1.2" "2.6.5" "2.5.5" "2.6.4" "2.6.3"
    "3.1.1" "3.1.0" "2.6.2" "3.0.1" "2.5.4" "2.5.3" "2.4.6" "2.6.1" "3.0.0"
    "2.6.0" "2.3.7" "2.4.5" "2.5.2" "2.5.1" "2.3.6" "2.4.4" "2.5.0" "2.4.3"
    "2.4.2" "2.4.1" "2.3.5" "2.4.0" "2.3.4" "2.3.3" "2.3.2" "2.3.1" "2.3.0"
    "2.2.3" "2.2.2" "2.2.1" "2.1.3" "2.2.0" "2.0.1"
  )
